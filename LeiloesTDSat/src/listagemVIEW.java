...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    if (sucesso) {
        ...
        listarProdutosVendidos(); // Chama o método para listar apenas os produtos vendidos
    } else {
        JOptionPane.showMessageDialog(this, "Falha ao vender o produto. Verifique o ID do produto.");
    }

    }//GEN-LAST:event_btnVenderActionPerformed

    private void btnVendasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVendasActionPerformed
        listagemVIEW telaVendas = new listagemVIEW();
...
private void listarProdutosVendidos() {
    try {
        ...
        e.printStackTrace(); // Apenas para depuração, considere lidar com exceções de forma adequada
    }
}
}